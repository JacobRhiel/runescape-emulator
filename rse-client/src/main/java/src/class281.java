...
public class class281 {
   ...
   public void method5024(class309 var1, int var2) {
      ...
      var1.writeShort((int)var3, (byte)-61);
      ...
      var1.writeShort((int)var5, (byte)-110);
      ...
      var1.writeShort((int)var7, (byte)-125);
      var1.writeShort(this.field3578, (byte)-48);
      var1.writeShort(this.field3583, (byte)-121);
      var1.writeShort(this.field3584, (byte)-104);
      var1.writeShort(this.field3586, (byte)-72);
   }
