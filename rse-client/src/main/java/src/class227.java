...
public class class227 {
   ...
   protected static class175 field2710;
   ...
   static final void method4160(int var0) {
      ...
      for(class70 var2 = (class70)client.field841.method5995(); var2 != null; var2 = (class70)client.field841.method6003()) {
         if(var2.field593 == 0 || var2.field593 == 3) {
            class41.method653(var2, true, 590728412);
         }
      }

      if(client.field882 != null) {
         class68.method1273(client.field882, 128525821);
         client.field882 = null;
      }

   }

   public static int method4176(int var0, int var1) {
