...
import rs.emulator.world.map.collision.CollisionFlags.BLOCKED
import rs.emulator.world.map.collision.CollisionFlags.BLOCKED_NORTH_EAST
import rs.emulator.world.map.collision.CollisionFlags.BLOCKED_NORTH_WEST
import rs.emulator.world.map.collision.CollisionFlags.BLOCKED_SOUTH_EAST
import rs.emulator.world.map.collision.CollisionFlags.BLOCKED_SOUTH_WEST
import rs.emulator.world.map.collision.CollisionFlags.CLEAR_EAST
import rs.emulator.world.map.collision.CollisionFlags.CLEAR_NORTH
import rs.emulator.world.map.collision.CollisionFlags.CLEAR_SOUTH
import rs.emulator.world.map.collision.CollisionFlags.CLEAR_WEST
import rs.emulator.world.map.collision.CollisionFlags.CORNER_OBJ_NORTH_EAST_BLOCKS_WALK_ALTERNATIVE
import rs.emulator.world.map.collision.CollisionFlags.CORNER_OBJ_NORTH_WEST_BLOCKS_WALK_ALTERNATIVE
import rs.emulator.world.map.collision.CollisionFlags.CORNER_OBJ_SOUTH_EAST_BLOCKS_WALK_ALTERNATIVE
import rs.emulator.world.map.collision.CollisionFlags.CORNER_OBJ_SOUTH_WEST_BLOCKS_WALK_ALTERNATIVE
import rs.emulator.world.map.collision.CollisionFlags.WALL_OBJ_EAST_BLOCKS_WALK_ALTERNATIVE
import rs.emulator.world.map.collision.CollisionFlags.WALL_OBJ_NORTH_BLOCKS_WALK_ALTERNATIVE
import rs.emulator.world.map.collision.CollisionFlags.WALL_OBJ_SOUTH_BLOCKS_WALK_ALTERNATIVE
import rs.emulator.world.map.collision.CollisionFlags.WALL_OBJ_WEST_BLOCKS_WALK_ALTERNATIVE
