...
import rs.emulator.collections.StorableContainer
...
abstract class ItemContainer(
    ...
    abstract fun addItem(element: Item, containerState: ContainerState.() -> Unit = {})
    abstract fun removeItem(element: Item, containerState: ContainerState.() -> Unit = {})
