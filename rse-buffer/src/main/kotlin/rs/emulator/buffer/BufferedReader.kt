package rs.emulator.buffer

import io.netty.buffer.ByteBuf
import io.netty.buffer.Unpooled
import rs.emulator.buffer.type.DataType
import rs.emulator.buffer.type.access.AccessMode
...
import rs.emulator.buffer.utilities.DataConstants
...
open class BufferedReader
{
     ...
     * The current mode.
     */
    protected var mode = AccessMode.BYTE_ACCESS
